...
function addToCart(e) {
  ...
  var cartData = getCartData() || {}, // получаем данные корзины или создаём новый объект, если данных еще нет
    ...
    itemTitle = parentBox.querySelector(".name-product").innerHTML, // название товара
    itemPrice = parentBox.querySelector(".discont-price-product").innerHTML; // стоимость товара
