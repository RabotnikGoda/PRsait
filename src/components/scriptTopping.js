const dietTopping = [
  {
    ...
    structure:
      "Состав: мука льняная, апельсиновый сок, растительное масло, фруктоза, сода, маракуйя, персик, желатин, растительные сливки.",
  },
  {
    ...
    structure:
      "Состав: льняная мука, апельсиновый сок, растительное масло, сода, фруктоза, клубника, вишня, растительные сливки, желатин.",
  },
  {
    ...
    structure:
      "Состав: льняная мука, апельсиновый сок, растительное масло, сода, фруктоза, клюква, корица, растительные сливки, желатин.",
  },
  {
    ...
    structure:
      "Состав: яйцо, сахар, ваниль, сгущеное молоко, мак, растительные сливки.",
  },
  {
    ...
    structure:
      "Состав: яйцо, мука, сахар, ваниль, желатин, сливки, семена чиа, молоко.",
  },
  {
    ...
    structure:
      "Состав: яйцо, сахар, мука, какао, желатин, клубника, дыня, ваниль, Cream Cheese.",
  },
...
const topping = [
  {
    ...
    structure:
      "Состав: Масло сливочное, Мука пшеничная, Разрыхлитель, Сахар, Сахар ванильный, Соль, Шоколад",
  },
  {
  ...
  },
  {
    ...
    structure:
      "Состав: Состав: апельсин, яйцо, сахар, мука, какао, клубника, желатин, мята, Cream Chese.",
  },
  {
    ...
    structure:
      "Состав: яйцо, сахар, мука, ваниль, Cream Chese, малина, корица.",
  },
  {
